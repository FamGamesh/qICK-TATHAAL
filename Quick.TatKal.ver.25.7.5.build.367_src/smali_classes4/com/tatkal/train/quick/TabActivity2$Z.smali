...
.method public onCheckedChanged(Landroid/widget/CompoundButton;Z)V
    ...
    iget-object p1, v7, Lcom/tatkal/train/quick/TabActivity2$Z;->a:Lcom/tatkal/train/quick/TabActivity2;
    ...
    const-string v10, "Buy GOLD Pack"
    ...
    iget-object v5, v7, Lcom/tatkal/train/quick/TabActivity2$Z;->a:Lcom/tatkal/train/quick/TabActivity2;
    ...
    const-string v9, "Your free trial for UPI app automation is expired. Buy GOLD Pack now to enjoy this feature with unlimited tickets and all the other premium features for lifetime."
    ...
    const-string v10, "UPI Automation Trial Expired"

    move-object v5, v10

    invoke-virtual {p1, v5}, Landroid/app/AlertDialog$Builder;->setTitle(Ljava/lang/CharSequence;)Landroid/app/AlertDialog$Builder;

    new-instance v5, Lcom/tatkal/train/quick/TabActivity2$Z$a;

    const/4 v9, 0x1

    invoke-direct {v5, v7, p2}, Lcom/tatkal/train/quick/TabActivity2$Z$a;-><init>(Lcom/tatkal/train/quick/TabActivity2$Z;[Z)V

    const/4 v9, 0x5

    const-string v9, "Disable UPI Autofill"
    ...
    new-instance v5, Lcom/tatkal/train/quick/TabActivity2$Z$b;

    const/4 v10, 0x6

    invoke-direct {v5, v7}, Lcom/tatkal/train/quick/TabActivity2$Z$b;-><init>(Lcom/tatkal/train/quick/TabActivity2$Z;)V
    ...
    const-string v10, "UPI trial expired"

    move-object v4, v10

    invoke-virtual {p1, v3, v4}, Lu4/c;->Q(Ljava/lang/String;Ljava/lang/Object;)Lu4/c;

    iget-object v3, v7, Lcom/tatkal/train/quick/TabActivity2$Z;->a:Lcom/tatkal/train/quick/TabActivity2;
    ...
    const-string v9, "UPI app automation with UPI PIN auto submit is available only in GOLD Pack. But you can try this feature for free for 1 ticket booking.\n\nDo you want to try this feature now or buy GOLD Pack with lifetime validity with all the unlimited features unlocked."

    move-object v5, v9

    invoke-virtual {p1, v5}, Landroid/app/AlertDialog$Builder;->setMessage(Ljava/lang/CharSequence;)Landroid/app/AlertDialog$Builder;

    const-string v9, "Try UPI App Automation"

    move-object v5, v9

    invoke-virtual {p1, v5}, Landroid/app/AlertDialog$Builder;->setTitle(Ljava/lang/CharSequence;)Landroid/app/AlertDialog$Builder;

    new-instance v5, Lcom/tatkal/train/quick/TabActivity2$Z$c;

    const/4 v9, 0x3

    invoke-direct {v5, v7}, Lcom/tatkal/train/quick/TabActivity2$Z$c;-><init>(Lcom/tatkal/train/quick/TabActivity2$Z;)V
    ...
    new-instance v5, Lcom/tatkal/train/quick/TabActivity2$Z$d;

    const/4 v10, 0x4

    invoke-direct {v5, v7}, Lcom/tatkal/train/quick/TabActivity2$Z$d;-><init>(Lcom/tatkal/train/quick/TabActivity2$Z;)V
    ...
    const-string v9, "Before UPI trial"
